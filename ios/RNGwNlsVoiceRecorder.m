...
@interface RNGwNlsVoiceRecorder()
{
...
@implementation RNGwNlsVoiceRecorder
...
static void inputBufferHandler(void *                          inUserData,
    ...
    @autoreleasepool {
        ...
        RNGwNlsVoiceRecorder *recorder = (__bridge RNGwNlsVoiceRecorder*) inUserData;
